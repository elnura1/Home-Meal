...
import 'buyproduct_model.dart';
export 'buyproduct_model.dart';

class BuyproductWidget extends StatefulWidget {
  const BuyproductWidget({super.key});
...
class _BuyproductWidgetState extends State<BuyproductWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BuyproductModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'buyproduct'});
        ...
        body: Column(
          ...
          children: [
            ...
            InkWell(
              ...
              onTap: () async {
                logFirebaseEvent('BUYPRODUCT_Container_d0xtp1c6_ON_TAP');
