...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'AuthFoodReg',
          path: '/authFoodReg',
          builder: (context, params) => const AuthFoodRegWidget(),
        ),
        FFRoute(
          name: 'AuthFoodLogin',
          path: '/authFoodLogin',
          builder: (context, params) => const AuthFoodLoginWidget(),
        ),
        FFRoute(
          name: 'AuthFoodForget',
          path: '/authFoodForget',
          builder: (context, params) => const AuthFoodForgetWidget(),
        ),
        FFRoute(
          name: 'AddMembers',
          path: '/addMembers',
        ...
        FFRoute(
          ...
          path: '/proffileSummary',
          builder: (context, params) => const ProffileSummaryWidget(),
        ),
        FFRoute(
          name: 'Proffilanotheruaer',
          path: '/proffilanotheruaer',
          builder: (context, params) => const ProffilanotheruaerWidget(),
        ),
        FFRoute(
