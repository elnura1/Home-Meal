...
import 'auth_food_reg_model.dart';
export 'auth_food_reg_model.dart';

class AuthFoodRegWidget extends StatefulWidget {
  const AuthFoodRegWidget({super.key});

  @override
  State<AuthFoodRegWidget> createState() => _AuthFoodRegWidgetState();
}

class _AuthFoodRegWidgetState extends State<AuthFoodRegWidget>
    with TickerProviderStateMixin {
  late AuthFoodRegModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuthFoodRegModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'AuthFoodReg'});
                                              ...
                                              children: [
                                                Padding(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'AUTH_FOOD_REG_PAGE_Text_bxlflwqr_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Text_navigate_to');
                                            ...
                                            Align(
                                              ...
                                              child: Padding(
                                                ...
                                                child: FFButtonWidget(
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'AUTH_FOOD_REG_ЗАРЕГИСТРИРОВАТЬСЯ_BTN_ON_');
                                                    logFirebaseEvent(
                                                        'Button_auth');
                                                    GoRouter.of(context)
                                                        .prepareAuthEvent();
