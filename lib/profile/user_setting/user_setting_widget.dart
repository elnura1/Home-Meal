...
class _UserSettingWidgetState extends State<UserSettingWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'UserSetting'});
    setupAnimations(
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: const Color(0xFF410E0B),
        appBar: AppBar(
          backgroundColor: const Color(0xFF410E0B),
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('USER_SETTING_arrow_back_rounded_ICN_ON_T');
          ...
          actions: [
            Padding(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  logFirebaseEvent('USER_SETTING_PAGE_lightDark_small_ON_TAP');
