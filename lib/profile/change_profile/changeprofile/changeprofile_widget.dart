...
class _ChangeprofileWidgetState extends State<ChangeprofileWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Changeprofile'});
    setupAnimations(
        ...
        appBar: AppBar(
          ...
          leading: Container(
            ...
            child: FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('CHANGEPROFILE_arrow_back_rounded_ICN_ON_');
                                            ...
                                            Container(
                                              ...
                                              child: Padding(
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'CHANGEPROFILE_PAGE_Image_ecqhsytd_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Image_navigate_to');
                                        ...
                                        child: Container(
                                          ...
                                          child: Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'CHANGEPROFILE_PAGE_bottomContent_ON_TAP');
                                                logFirebaseEvent(
                                                    'bottomContent_navigate_to');
                                              ...
                                              children: [
                                                Expanded(
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'CHANGEPROFILE_Container_v85in4i0_ON_TAP');
                                                      logFirebaseEvent(
                                                ...
                                                Expanded(
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'CHANGEPROFILE_Container_i38v02l1_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Container_set_dark_mode_settings');
                                                      setDarkModeSetting(
                                                          context,
