...
class _DetailsSocialPostWidgetState extends State<DetailsSocialPostWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'DetailsSocialPost'});
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            Row(
                              ...
                              children: [
                                FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'DETAILS_SOCIAL_POST_arrow_back_ios_round');
                                    logFirebaseEvent(
                    ...
                    RatingBar.builder(
                      ...
                      itemCount: 5,
                      itemSize: 40.0,
                      glowColor: const Color(0xFF410E0B),
                    ),
                    Padding(
                      padding:
                ...
                children: [
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'DETAILS_SOCIAL_POST_PAGE_BUY_BTN_ON_TAP');
                        logFirebaseEvent('Button_navigate_to');

                        context.pushNamed('buyproduct');
                      },
                      text: 'Buy',
                      icon: const Icon(
                        Icons.shopping_bag,
