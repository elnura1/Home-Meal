...
class _AddMembersWidgetState extends State<AddMembersWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'AddMembers'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('ADD_MEMBERS_AddMembers_ON_INIT_STATE');
      logFirebaseEvent('AddMembers_navigate_to');

      context.pushNamed('Proffilanotheruaer');
    });
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('ADD_MEMBERS_arrow_back_rounded_ICN_ON_TA');
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: FlutterFlowIconButton(
                        borderColor: const Color(0xFF410E0B),
                        borderRadius: 30.0,
                        borderWidth: 1.0,
                        buttonSize: 44.0,
                        icon: Icon(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent('ADD_MEMBERS_PAGE_row_ON_TAP');
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'ADD_MEMBERS_PAGE_VIEW_BTN_ON_TAP');
