            ...
            actions: [
              Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent('PROFILE_PAGE_lightDark_small_ON_TAP');
                  ...
                  children: [
                    Expanded(
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          logFirebaseEvent('PROFILE_PAGE_Myprofile_ON_TAP');
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'PROFILE_PAGE_Notification_button_ON_TAP');
                            logFirebaseEvent('Notification_button_navigate_to');
                    ...
                    Expanded(
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'PROFILE_PAGE_Column_0gleuxt0_ON_TAP');
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'PROFILE_PAGE_AddFreund_button_ON_TAP');
                                    logFirebaseEvent(
                                        'AddFreund_button_navigate_to');
                              ...
                              child: AnimatedContainer(
                                ...
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'PROFILE_PAGE_settingbutton_ON_TAP');
                                      logFirebaseEvent(
                                          'settingbutton_navigate_to');
                              ...
                              child: AnimatedContainer(
                                ...
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'PROFILE_PAGE_Buissnes_button_ON_TAP');
                                      logFirebaseEvent(
                                          'Buissnes_button_navigate_to');

                                      context.pushNamed('ProffileSummary');
                                    },
                                    child: Row(
                                      mainAxisSize: MainAxisSize.max,
                                      children: [
                              ...
                              child: AnimatedContainer(
                                ...
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'PROFILE_PAGE_option_ON_TAP');
                                      logFirebaseEvent('option_call_number');
                                      await launchUrl(Uri(
                                        scheme: 'tel',
                                        path: '996709467706',
                                      ));
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  context.pushNamed('AuthFoodLogin');
                                },
                                text: 'Logout',
